...
PARAMETERS = [
    ("csv1.csv", "csv1.csv", "csv", "csv", None, None, None, None, None, "r"),
    ("csv2.csv", "csv1.csv", "csv", "csv", ";", None, None, None, None, "r"),
    ("csv1.csv", "csv2.csv", "csv", "csv", None, ";", None, None, None, "r"),
    ("csv2.csv", "csv2.csv", "csv", "csv", ";", ";", None, None, None, "r"),
    ("csv3.csv", "csv1.csv", "csv", "csv", None, None, None, 0, None, "r"),
    ("csv4.csv", "csv1.csv", "csv", "csv", None, None, 0, None, None, "r"),
    ...
    (
        ...
        None,
        None,
        "reznik_triska, neumi_dotu",
        "r",
    ),
    ("csv1.csv", "fimi1.fimi", "csv", "fimi", None, None, None, None, None, "r"),
    ("csv1.csv", "burmeister1.cxt", "csv", "cxt", None, None, None, None, None, "r"),
    ("mat1.mat", "csv8.csv", "mat", "csv", None, None, None, None, None, "rb"),
    ("cex1.cex", "csv9.csv", "cex", "csv", None, None, None, None, None, "r"),
]
...
def input_file(request):
    return os.path.join(
        os.path.dirname(os.path.realpath(__file__)), "test_data/", request.param
    )
...
def __append_args(
    args, input_delimiter, output_delimiter, true_values, attributes_row, objects_col
):
...
def test_cli_stdin_stdout(
    ...
    with runner.isolated_filesystem():
        args = ["-if={}".format(input_format), "-of={}".format(output_format)]
